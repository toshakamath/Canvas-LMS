...
//       }
//     };
//     //cb will get called after we hget the response of makeRequest
//     rpc.makeRequest(topic_queue, payload, cb);  //this indirectly calls kafka backend
...
// app.get("/user_signup",(req,res, next)=>{
//   req.topic_queue="users";
//   req.topic_subtype="signupUser";
//   next();
// } ,makeReq);  //registerRequest
app.post("/user_signup", auth.signupUser);
app.post("/user_login", auth.loginUser);
