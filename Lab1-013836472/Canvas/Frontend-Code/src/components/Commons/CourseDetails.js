...
export default class CourseDetails extends Component {    
      ...
      componentDidMount() {
        ...
        axios
          ...
          .then((response) => {
            ...
            //console.log("inside axios", this.state.courseinfo);
  ...
  render() {
    ...
    console.log("this.state.courseinfo: ",this.state.courseinfo);
    let courseid = this.state.courseinfo.map((object) => {
      return object.courseid;
    });
    let coursename = this.state.courseinfo.map((object) => {
      return object.coursename;
    });
    let coursedept = this.state.courseinfo.map((object) => {
      return object.coursedept;
    });
    let coursedesc = this.state.courseinfo.map((object) => {
      return object.coursedesc;
    });
    let courseterm = this.state.courseinfo.map((object) => {
      return object.courseterm;
    });
    let courseroom = this.state.courseinfo.map((object) => {
      return object.courseroom;
    });
    let coursecapacity = this.state.courseinfo.map((object) => {
      return object.coursecapacity;
    });
    let currentcapacity = this.state.courseinfo.map((object) => {
      return object.currentcapacity;
    });
    let waitlistcapacity = this.state.courseinfo.map((object) => {
      return object.waitlistcapacity;
    });
    let currentwaitlistcapacity = this.state.courseinfo.map((object) => {
