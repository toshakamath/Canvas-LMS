...
import "../../App.css";
import {displayAssignment} from "../../actions/AssignmentAction";
...
class DisplayAssignment extends Component {
  ...
  componentDidMount() {
    ...
    this.props.displayAssignment(data);
  }
  createAssignments = (e) => {
    let courseid =((this.props.match||{}).params||{}).courseid;
    e.preventDefault();
  ...
  render() {
    ...
    let details = this.props.assignmentdetails.displayassignment.map((assignment) => {
...
export default connect (mapStateToProps,{displayAssignment})(DisplayAssignment)
